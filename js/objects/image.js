class Image {
    ...
    async captureInfraredImage(preview) {
        ...
        const image = {
            ...
            processed: {
                ...
                points: rayPointsGround.map((p) => {
                    return new THREE.Vector3(
                        Math.fround(p.x * this.resolution.x / max.x),
                        0,
    ...
    async captureMonochromeImage(preview) {
        ...
        const image = {
            rendered: {
                center: new THREE.Vector3(
                    Math.floor(this.view.x),
                    0,
                    Math.floor(this.view.z)
                ),
            ...
            processed: {
                center: new THREE.Vector3(
                    Math.floor(this.view.x * this.resolution.x / max.x),
                    0,
                    Math.floor(this.view.z * this.resolution.z / max.z)
                ),
